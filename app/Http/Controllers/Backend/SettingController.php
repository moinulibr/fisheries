...
class SettingController extends Controller
{
    ...
    public function update(Request $request, Setting $setting)
    {
        ...
        {
            $this->destination  = 'setting/site-logo';  //its mandatory
            $this->imageWidth   = 400;  //its mandatory
            $this->imageHeight  = 400;  //its nullable
            $this->requestFile  = $request->site_logo;  //its mandatory
            $this->dbImageField = $setting->site_logo;  //its mandatory
            $setting->site_logo = $this->updateImage();
            $setting->save();
        }
